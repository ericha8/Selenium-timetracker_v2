...
public class TC006_TimeTracker_DailyWorkHoursPopUp_AllTasksTab_Tasks {
	...
	public static void dailyWorkHoursPopUpAllTasksTabTasks() {
		...
		System.out.println("-------------------------------------------------------------------");
		System.out.println("|| TC006_TimeTracker_Daily Work Hours pop up_All Tasks tab_Tasks ||");
		System.out.println("-------------------------------------------------------------------");
		...
		// Click All Tasks tab
		chargeHours.clickAllTasksTab(driver);		
		
		// Click any of task in All Tasks tab
		chargeHours.clickAnyTask(driver);		
